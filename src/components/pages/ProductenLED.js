...
function ProductenLED() {
    const collageImages = [
        {
            src: "../images/led_verlichting/1.jfif",
            alt: "LED Display 1"
        },
        {
            src: "../images/led_verlichting/2.jpeg",
            alt: "LED Display 2"
        },
        {
            src: "../images/led_verlichting/3.jfif",
            alt: "LED Display 3"
        },
        {
            src: "../images/led_verlichting/4.jpeg",
            alt: "LED Display 4"
        },
        {
            src: "../images/led_verlichting/5.jfif",
            alt: "LED Display 5"
        }
    ];
	...
	const secondSetOfImages = [
        {
            src: "../images/led_verlichting/6.jfif",
            alt: "LED Display 6"
        },
        {
            src: "../images/led_verlichting/7.jfif",
            alt: "LED Display 7"
        },
        {
            src: "../images/led_verlichting/8.jfif",
            alt: "LED Display 8"
        },
        {
            src: "../images/led_verlichting/9.jfif",
            alt: "LED Display 9"
        },
		{
            src: "../images/led_verlichting/10.jfif",
            alt: "LED Display 10"
        }
    ];
